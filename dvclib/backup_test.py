...
class BackupTests(unittest.TestCase):
	...
	@patch('dvclib.backup.git_ls_remote', return_value='')
	def test_is_empty_repo_returns_true_for_empty_repo(self, mock):
		git_repo_url = 'git@gitlab.rc.uab.edu:CCTS-Microbiome/chen-dq/sross-denovo.git'
		self.assertTrue(is_empty_repo(git_repo_url))

	@patch('dvclib.backup.git_ls_remote', return_value='88dea3f7714cde9732def1c4ae566bb383a665d6')
	def test_is_empty_repo_returns_false_for_repo_with_at_least_one_commit(self, mock):
		git_repo_url = 'git@gitlab.rc.uab.edu:CCTS-Microbiome/chen-dq/sross-denovo.git'
	...
	''')
	def test_exists_repo_returns_false_for_deleted_repo(self, mock):
		git_repo_url = 'git@gitlab.rc.uab.edu:CCTS-Microbiome/chen-dq/sross-denovo.git'
